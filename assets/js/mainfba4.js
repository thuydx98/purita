$(document).ready(function () {
  ...
  $(".btn_nav").click(function () {
    ...
    if ($(".overplay-mobile").is("visible")) {
      ...
      setTimeout(function () {
        ...
        $(".banner-projects-w .banner-project").css({
          "background-attachment": "inherit",
        });
        $(".banner-projects-w .banner").css({
          "background-attachment": "inherit",
        });
  ...
  setHeightMapListItemMapMobile = function () {
    setTimeout(function () {
      ...
      if (iOS) {
        height_listitem =
          height_window - (height_search + h_topnav + height_map);
      } else {
        height_listitem =
          height_window_default - (height_search + h_topnav + height_map);
      }
