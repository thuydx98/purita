...
var config = {
  ...
  SecretKey: [
    "4d2adc2749dd4da7a79514e41ce5c481",
    "lZvLSWcQ7WYkn0Ny//3S3dDh23Wly9+CyhLJbO2ioQg=",
  ],
...
function MapClass(options) {
  ...
  this.addMarker = function (options, callback) {
    ...
    google.maps.event.addListener(f, "click", function () {
      ...
      $(".outlet-all .item#outlet_list_" + options.OutletCode).addClass(
        "active"
      );
  ...
  function addButtonMap(g, k, i) {
    ...
    if (i && i.geolocation) {
      g.controls[
        i.geolocation.position || google.maps.ControlPosition.RIGHT_BOTTOM
      ].push(l);
    } else {
